...
parent      =  extends Summable[String] {
  def sum(a1: String, a2: String): String = null
} # -1,
parent span = <968..1035>,
child       = def sum(a1: String, a2: String): String = null # -1,
child span  = [994..998..1047]
...
object Ex4Summables:
  ...
  given Summable[String] with
    def sum(a1: String, a2: String): String = 
