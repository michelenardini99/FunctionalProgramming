...
parent      =  extends Traversable[Sequence] {
  def logAll[A](container: Sequence[A])(consumer: (A) => Unit): Unit =
    container mCURSOR null
} # -1,
parent span = <1321..1436>,
child       = def logAll[A](container: Sequence[A])(consumer: (A) => Unit): Unit =
  container mCURSOR null # -1,
child span  = [1352..1356..1439]
...
object Ex5Traversable:
  ...
  given Traversable[Sequence] with
    def logAll[A](container: Sequence[A])(consumer: A => Unit): Unit = container m@@
