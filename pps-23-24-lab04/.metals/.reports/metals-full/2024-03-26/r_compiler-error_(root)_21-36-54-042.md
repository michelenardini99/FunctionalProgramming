...
parent      =  extends Traversable[Optional] {
  def logAll[A](container: Optional[A])(consumer: (A) => Unit): Unit = null
} # -1,
parent span = <1145..1242>,
child       = def logAll[A](container: Optional[A])(consumer: (A) => Unit): Unit = null # -1,
child span  = [1176..1180..1246]
