...
parent      =  extends Summable[Double] {
  def sum(a1: Double, a2: Double): Double = null
} # -1,
parent span = <858..953>,
child       = def sum(a1: Double, a2: Double): Double = null # -1,
child span  = [884..888..957]
...
object Ex4Summables:
  ...
  given Summable[Double] with
    def sum(a1: Double, a2: Double): Double = 
    def zero: Double = ???
